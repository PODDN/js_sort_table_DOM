...
headers.forEach((header, index)=>{
    header.addEventListener("click", ()=>{
        ...
        tRows.sort((a, b)=>{
            ...
            if (index === 0 || index === 1) return firstParam.localeCompare(secondParam);
            if (index === 2) return firstParam - secondParam;
            if (index === 3) return Number(firstParam.replace(/[$,]/g, "")) - Number(secondParam.replace(/[$,]/g, ""));
        });
        tBody.innerHTML = "";
